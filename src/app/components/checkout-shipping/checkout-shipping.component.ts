import { Component, OnInit, EventEmitter, Output, AfterContentChecked, SimpleChanges, Input, OnChanges } from '@angular/core';
...
@Component({
    ...
    templateUrl: '../../views/checkout-shipping.component.html',
})
