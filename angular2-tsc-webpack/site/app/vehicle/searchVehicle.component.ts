...
import { VehicleBrand } from "../_models/vehicle/vehicleBrand";
import { VehicleYear } from "../_models/vehicle/vehicleYear";
...
@Component({
    moduleId: module.id,
    selector: 'vehicle',
    templateUrl: '/views/searchVehicle.component.html'
})
